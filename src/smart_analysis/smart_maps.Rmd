...
ggsave(here('./output/smart_analysis/plots/maps/fitted_p_smart.pdf'), plot = g_fitted_p_smart, width = 5, height = 5, units = 'in', dpi = 300)
g_fitted_p_smart
...
ggsave(here('./output/smart_analysis/plots/maps/fitted_p_basel.pdf'), plot = g_fitted_p_smart, width = 5, height = 5, units = 'in', dpi = 300)
g_fitted_p_basel
```
...
g_fitted_p_delta_hist <- ggplot(va_bgs) + geom_histogram(aes(x = delta_fitted),
  ...
  ylab('Count')
ggsave(here('./output/smart_analysis/plots/fitted_p_delta_hist.pdf'), plot = g_fitted_p_delta_hist, width = 8, height = 5, units = 'in', dpi = 300)
...
ggsave(here('./output/smart_analysis/plots/maps/fitted_p_delta.pdf'), plot = g_fitted_p_delta, width = 5, height = 5, units = 'in', dpi = 300)
g_fitted_p_delta
```
